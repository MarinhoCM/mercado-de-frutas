                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <?= $this->Html->link(__('Edit'), ['controller' => 'Sales', 'action' => 'edit', $sale->id]) ?>
                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'Sales', 'action' => 'delete', $sale->id], ['confirm' => __('Are you sure you want to delete # {0}?', $sale->id)]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
